...
import './LuasGreenLineComponent.css';
import MaterialTableComponent from '../MaterialTableComponent/MaterialTableComponent';
import TitleComponent from '../TitleComponent/TitleComponent';
import Select from "react-dropdown-select";
import {luasGreenLineData} from '../../LuasGreenLineData';

import styled from '@emotion/styled';
import Typography from '@material-ui/core/Typography';

class LuasGreenLineComponent extends Component {
  state = {
      inboundTime: '',
      outboundTime: '',
      inboundDestination: '',
  ...
  render() {
    ...
    return (
      <div className="LuasGreenLineComponent">
      <Typography variant="display3">Green Line</Typography>
        <StyledSelect options={luasGreenLineData} clearOnSelect={true} labelField="pronunciation"  valueField="abrev" values={[]} onChange={
...
export default LuasGreenLineComponent;
